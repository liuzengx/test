...
<head>
    ...
    <script src="<%=request.getContextPath()%>/js/bootstrap/bootstrap-table.js"></script>
    <link href="<%=request.getContextPath()%>/css/bootstrap/bootstrap-table.css" rel="stylesheet" />
    <script src="<%=request.getContextPath()%>/js/bootstrap/bootstrap-table-zh-CN.js"></script>
...
<body>
    <div class="panel-body"  style="padding: 10px;">
     ...
     <div id="system_sessionslog_toolbar" class="btn-group" style="margin-bottom: 6px;">
            <button id="stockProfit_btn_add" type="button" class="btn btn-default">
                <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>新增
            </button>
            <button id="stockProfit_btn_edit" type="button" class="btn btn-default">
                <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>修改
            </button>
            <button id="stockProfit_btn_delete" type="button" class="btn btn-default">
    ...
    <div id="stockProfit_add_content" style="display: none">
		<form id="addUserForm" class="form-horizontal" style="padding: 15px">
			<div class="form-group">
				...
				<div class="col-xs-4">
					<input type="text" class="form-control" id="stockName" name="stockName" placeholder="股票名称">
				</div>
			</div>
			<div class="form-group">
				<label for="stockCost" class="col-xs-2 control-label">买入单价:</label>
				<div class="col-xs-4">
					<input type="text" class="form-control" id="stockCost" name="stockCost" placeholder="成本单价">
				</div>
				<label for="stockDeal" class="col-xs-2 control-label">卖出单价:</label>
				<div class="col-xs-4">
					<input type="text" class="form-control" id="stockDeal" name="stockDeal" placeholder="成交单价">
				</div>
			</div>
			<div class="form-group">
				<label for="dealNumber" class="col-xs-2 control-label">数量(股):</label>
				<div class="col-xs-4">
					<input type="text" class="form-control" id="dealNumber" name="dealNumber" placeholder="数量(股)">
				</div>
				<label for="dealDate" class="col-xs-2 control-label">成交日期:</label>
				<div class="col-xs-4">
					<input type="text" class="form-control" id="dealDate" name="dealDate" placeholder="成交日期">
				</div>
			</div>
			<div class="form-group">
				<label for="buyTotal" class="col-xs-2 control-label">买入金额:</label>
				<div class="col-xs-4">
					<input type="text" class="form-control" id="buyTotal" name="buyTotal" placeholder="买入金额">
				</div>
				<label for="sellTotal" class="col-xs-2 control-label">卖出金额:</label>
				<div class="col-xs-4">
					<input type="text" class="form-control" id="sellTotal" name="sellTotal" placeholder="卖出金额">
				</div>
			</div>
			<div class="form-group">
				<label for="stockProfit" class="col-xs-2 control-label">毛利润:</label>
				<div class="col-xs-4">
					<input type="text" class="form-control" id="stockProfit" name="stockProfit" style="cursor: pointer" placeholder="毛利润" readonly>
				</div>
				<label for="stockNetProfit" class="col-xs-2 control-label">净利润:</label>
				<div class="col-xs-4">
					<input type="text" class="form-control" id="stockNetProfit" name="stockNetProfit" style="cursor: pointer" placeholder="净利润" readonly>
				</div>
			</div>
			<div class="form-group">
				<label for="taxAmount" class="col-xs-2 control-label">税额:</label>
				<div class="col-xs-4">
					<input type="text" class="form-control" id="taxAmount" name="taxAmount" style="cursor: pointer" placeholder="税额" readonly>
				</div>
			</div>
			<%-- <div class="form-group">
...
<script src="<%=request.getContextPath()%>/views/stock/profit/list.js?v=${v}"></script>
