...
function callbackdata() {
    ...
    var obj = { "stockCode": stockCode, "stockName": stockName,"sellTotal": sellTotal,"stockCost": stockCost,"stockDeal": stockDeal,"dealNumber": dealNumber,"dealDate": dealDate,"buyTotal": buyTotal,"sellTotal": sellTotal};
